    ...
    <div className="bg-gray-200 h-screen">
      <div className="flex">
        ...
        <div>
          {/* offcanvas start */}
          <button
            className="inline-block px-3 py-2.5 bg-amber-400 text-black  font-medium text-xs leading-tight uppercase rounded  text-lg shadow-md  hover:shadow-lg focus:shadow-lg  focus:outline-none focus:ring-0  active:shadow-lg transition duration-150 ease-in-out mr-1.5  absolute bottom-20 right-20"
            type="button"
